(() => {
    ...
    function initSliders() {
        if (document.querySelector(".car-slider__slider")) new core(".car-slider__slider", {
            ...
            navigation: {
                prevEl: ".car-slider__arrow-wrapp_prev",
                nextEl: ".car-slider__arrow-wrapp_next"
            },
            breakpoints: {
                0: {
                    slidesPerView: 1,
        ...
        if (document.querySelector(".advantages-slider__slider")) new core(".advantages-slider__slider", {
            modules: [ Navigation, Autoplay ],
            spaceBetween: 10,
            slidesPerView: 1,
            speed: 800,
            ...
            navigation: {
                prevEl: ".advantages-slider__arrow-wrapp_prev",
                nextEl: ".advantages-slider__arrow-wrapp_next"
            },
            on: {}
        });
    }
...
*/
    ...
    function galleryAnimation() {
        gsapWithCSS.to(".works__image-ibg", {
            duration: 1,
            opacity: 1,
            scale: 1,
            stagger: {
    ...
    class ScrollWatcher {
        ...
        scrollWatcherIntersecting(entry, targetElement) {
            if (entry.isIntersecting) {
                ...
                targetElement.classList.contains("works__items") ? galleryAnimation() : null;
                console.log("234");
    ...
    if (cards.length > 0) {
        let i = 0;
        cards.forEach((card => {
            if (card.classList.contains("card_detail")) i = 0;
            card.style.transitionDelay = i / 4 + "s";
            i++;
        }));
    }
    window["FLS"] = true;
